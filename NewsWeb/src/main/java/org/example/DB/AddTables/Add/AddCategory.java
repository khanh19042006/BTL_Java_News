...
public class AddCategory {
    ...
    public static void importFromJson(String jsonPath) {
        ...
        String selectSql = "SELECT code, name FROM category WHERE id = ?";
        String updateSql = """
                UPDATE category
                SET code = ?, name = ?
                WHERE id = ?
        ...
        try (Connection connection = DBConnection.getConnection();
            ...
            List<CategoryData> list = gson.fromJson(reader, listType);
            ...
            System.out.println("Updated Category: " + updatedCount);
            System.out.println("Skipped Category: " + skippedCount);
